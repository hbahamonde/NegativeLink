...
% political correlate
The political correlate is that a weak inter-sectoral structure---e.g., a lack of structural complementarity---will truncate the emergence of a strong political challenger---the industrial class---able to contest the landed elites. When the economy was structured in a way where both economic sectors were mutually dependent, each sector's corresponding political arm had the same military resources, and similar access to other bargaining assets, fostering inter-elite cooperation. And in turn, inter-elite contestation promoted political development. As \citet[1085]{Hechter1980a} explain, ``state formation will be more likely to the degree that powerful individual actors form two groups on the basis of divergent economic and political interests.'' Here I explain how these sectoral dynamics, helped to form the Latin American state, fostering economic growth as well. In other words, it is argued that political development is more likely to be sustained under sectoral balanced economic growth because it fosters a \emph{level} ``playing'' political field. 
