...
% productivity
	...
	``Agricultural activity is characterised by diminishing returns to scale [while] In manufacturing, expansion of productive activity proceeds with constant returns to scale'' (\citet[311]{Jorgenson1961}).
